...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--conf-file', default='./configs/yolov6t_finetune.py', type=str, help='experiments description file')
    ...
    parser.add_argument('--workers', default=20, type=int, help='number of data loading workers (default: 8)')
